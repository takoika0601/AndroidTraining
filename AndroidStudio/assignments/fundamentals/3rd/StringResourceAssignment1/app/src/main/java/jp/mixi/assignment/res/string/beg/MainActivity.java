...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String quantity1 = getResources().getQuantityString(R.plurals.my_apple, 1, 1);
        String quantity2 = getResources().getQuantityString(R.plurals.my_apple, 2, 2);

        textView1.setText(quantity1);
